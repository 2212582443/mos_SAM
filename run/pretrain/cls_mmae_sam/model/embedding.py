...
class SamPromptEncoder(Module):
    def __init__(
        ...
        self.embed_image = ImageEmbeddingMae(vision_config)
        self.positional_embedding = SamPositionalEmbedding(vision_config)

        self.cls_embedding = ClsEmbedding(prompt_config)
    ...
    def forward(self, cls_prompt: ClsTypeTokenEmbeddingTensor) -> SparseEmbeddingsTensor:
        sparse_embeddings = self.cls_embedding(cls_prompt)
